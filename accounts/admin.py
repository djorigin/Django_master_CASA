...
class PilotProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'role', 'arn', 'availability_status', 'is_repl_expired', 'repl_expiry')
    ...
    fieldsets = (
        ...
        (_('Licenses & Certifications'), {'fields': ('repl_number', 'repl_expiry', 'medical_clearance_date', 'certifications')}),
        (_('Contact Information'), {'fields': ('contact_number', 'address', 'home_base_location')}),
        (_('Emergency Contact'), {'fields': ('emergency_contact_name', 'emergency_contact_phone')}),
        (_('Documents'), {'fields': ('photo_id',)}),
        (_('Additional Information'), {'fields': ('notes',)}),
        (_('System Information'), {'fields': ('is_repl_expired', 'is_available', 'created_at', 'updated_at'), 'classes': ('collapse',)}),
    )
...
class ClientProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'company_name', 'industry', 'status', 'account_manager', 'created_at')
    list_filter = ('industry', 'status', 'created_at')
    search_fields = ('user__first_name', 'user__last_name', 'company_name', 'abn')
    readonly_fields = ('created_at', 'updated_at', 'is_active')
    fieldsets = (
        (_('User Information'), {'fields': ('user',)}),
        (_('Company Details'), {'fields': ('company_name', 'abn', 'industry', 'status')}),
        (_('Business Information'), {'fields': ('credit_limit', 'payment_terms', 'account_manager')}),
        (_('Contact Information'), {'fields': ('contact_number', 'billing_email', 'address')}),
        (_('Documents'), {'fields': ('photo_id',)}),
        (_('Additional Information'), {'fields': ('notes',)}),
        (_('System Information'), {'fields': ('is_active', 'created_at', 'updated_at'), 'classes': ('collapse',)}),
    )


@admin.register(OperatorCertificate)
class OperatorCertificateAdmin(admin.ModelAdmin):
    list_display = ('reoc_number', 'company_name', 'status', 'issue_date', 'expiry_date', 'is_expired', 'days_until_expiry')
    ...
    fieldsets = (
        (_('Certificate Information'), {'fields': ('reoc_number', 'casa_operator_number', 'status')}),
        (_('Company Information'), {'fields': ('company_name', 'contact_email')}),
        (_('Validity Period'), {'fields': ('issue_date', 'expiry_date')}),
        (_('System Information'), {'fields': ('is_expired', 'days_until_expiry', 'created_at', 'updated_at'), 'classes': ('collapse',)}),
    )
