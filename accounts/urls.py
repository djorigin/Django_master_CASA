...
urlpatterns = [
    ...
    path('certificates/create/', crud_views.certificate_create, name='certificate_create'),
    path('certificates/<int:pk>/', crud_views.certificate_detail, name='certificate_detail'),
    path('certificates/<int:pk>/edit/', crud_views.certificate_edit, name='certificate_edit'),
]