...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'date_joined', 'last_login', 'full_name', 'role_display'
        ]
...
class StaffProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StaffProfile
        fields = [
            'id', 'user', 'user_id', 'position_title', 'department', 
            'employee_id', 'hire_date', 'is_active', 'contact_number', 
            'address', 'photo_id'
        ]
...
class PilotProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'license_expiry_date', 'medical_certificate_expiry', 
            'total_flight_hours', 'drone_flight_hours', 'availability_status',
...
class ClientProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ClientProfile
        fields = [
            'id', 'user', 'user_id', 'company_name', 'abn', 'contact_number',
            'billing_address', 'service_address', 'preferred_communication',
            'status', 'registration_date', 'notes', 'photo_id'
        ]
...
class OperatorCertificateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'reoc_number', 'certificate_type', 'company_name',
            'contact_email', 'issue_date', 'expiry_date', 'status',
            'casa_operator_number', 'created_at', 'updated_at'
        ]
...
class CompanyContactDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'legal_entity_name', 'trading_name', 'display_name',
            'registered_office_address', 'arn', 'abn', 'operational_hq_address',
            'operational_hq_phone', 'operational_hq_email', 'organizational_overview',
...
class KeyPersonnelSerializer(serializers.ModelSerializer):
    ...
    chief_remote_pilot_id = serializers.IntegerField(write_only=True, required=False, allow_null=True)
    
    maintenance_controller = StaffProfileSerializer(read_only=True)
    maintenance_controller_id = serializers.IntegerField(write_only=True, required=False, allow_null=True)
    ...
    class Meta:
        model = KeyPersonnel
        fields = [
            'id', 'chief_remote_pilot', 'chief_remote_pilot_id', 'chief_remote_pilot_approved_date',
            'maintenance_controller', 'maintenance_controller_id', 'maintenance_controller_approved_date',
            'ceo', 'ceo_id', 'ceo_approved_date',
            'personnel_summary', 'vacant_positions', 'casa_compliant',
