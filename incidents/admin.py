...
class IncidentTypeAdmin(admin.ModelAdmin):
    ...
    search_fields = ["name", "description", "casa_reference"]
    fieldsets = (
        (
            "Basic Information",
            {"fields": ("name", "category", "severity", "description")},
        ),
        (
        ...
        (
            ...
            {"fields": ("investigation_required", "grounding_required")},
        ),
        ("Documentation", {"fields": ("casa_reference",)}),
    )
    ...
    def casa_reportable_display(self, obj):
        ...
        if obj.casa_reportable:
            ...
            return format_html(
                '<span style="color: {}; font-weight: bold;">{} Yes</span>', color, icon
            )
        else:
...
class IncidentReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            ...
            {"fields": ("incident_id", "incident_type", "status")},
        ),
        (
            "People & Assets",
            {"fields": ("aircraft", "pilot_in_command", "reported_by")},
        ),
        (
            "When & Where",
            {
        ...
        ("Flight Details", {"fields": ("flight_phase", "flight_hours_on_aircraft")}),
        (
            "Environmental Conditions",
            {"fields": ("weather_conditions", "wind_speed_knots", "visibility_meters")},
        ),
        ("Incident Description", {"fields": ("summary", "detailed_description")}),
        (
            "Damage & Impact",
            {"fields": ("aircraft_damage", "property_damage", "injuries")},
        ),
        ("Analysis", {"fields": ("contributing_factors", "immediate_causes")}),
        ("Actions Taken", {"fields": ("immediate_actions", "preventive_actions")}),
        (
            "CASA Reporting",
            {"fields": ("casa_reported", "casa_report_date", "casa_reference_number")},
        ),
        (
            "Investigation",
            {
        ...
        ("Follow-up", {"fields": ("follow_up_required", "follow_up_actions")}),
    )
    ...
    def aircraft_link(self, obj):
        ...
        if obj.aircraft:
            ...
            return format_html(
                '<a href="{}">{}</a>', url, obj.aircraft.registration_mark
            )
        return "-"
    ...
    def casa_status_display(self, obj):
        ...
        if obj.casa_reported:
            return format_html(
                ...
                (
                    obj.casa_report_date.strftime("%d/%m/%Y")
                    if obj.casa_report_date
                    else ""
                ),
            )
    ...
    def get_queryset(self, request):
        ...
        return (
            ...
            .select_related(
                "incident_type", "aircraft", "pilot_in_command__user", "reported_by"
            )
        )
