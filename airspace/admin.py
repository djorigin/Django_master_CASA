...
class AirspaceClassAdmin(admin.ModelAdmin):
    ...
    search_fields = ["name", "description", "casa_regulation_reference"]
    fieldsets = (
        (
            "Airspace Classification",
            {"fields": ("airspace_class", "name", "description")},
        ),
        (
        ...
        ("CASA References", {"fields": ("casa_regulation_reference",)}),
    )
...
class OperationalAreaAdmin(admin.ModelAdmin):
    ...
    search_fields = ["area_id", "name", "controlling_authority", "casa_reference"]
    fieldsets = (
        (
            "Area Identification",
            {"fields": ("area_id", "name", "area_type", "airspace_class")},
        ),
        (
        ...
        ("Time Restrictions", {"fields": ("effective_from", "effective_until")}),
        (
            "Contact Information",
            {"fields": ("controlling_authority", "contact_frequency", "contact_phone")},
        ),
        (
            "Documentation",
            {"fields": ("description", "operational_notes", "casa_reference")},
        ),
    )
