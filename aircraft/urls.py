...
urlpatterns = [
    ...
    path("types/<int:pk>/", crud_views.aircraft_type_detail, name="aircraft_type_detail"),
    path("types/<int:pk>/update/", crud_views.aircraft_type_update, name="aircraft_type_update"),
    path("types/<int:pk>/delete/", crud_views.aircraft_type_delete, name="aircraft_type_delete"),
    ...
    path("aircraft/<int:pk>/update/", crud_views.aircraft_update, name="aircraft_update"),
    path("aircraft/<int:pk>/delete/", crud_views.aircraft_delete, name="aircraft_delete"),
